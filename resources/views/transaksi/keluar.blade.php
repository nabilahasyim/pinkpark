...
<div class="card border-0 shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
        <h5 class="mb-0 fw-bold"><i class="fas fa-arrow-right-from-bracket me-2"></i>Data {{ $title }}</h5>
        <button class="btn btn-primary"><i class="fas fa-plus me-1"></i> Catat Kendaraan Keluar</button>
    </div>
    <div class="card-body">
